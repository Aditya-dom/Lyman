...
def main():
       web3 = Web3() 
       if WEB3_PROVIDE_INFURA else  Web3(Web3.HTTPProvider('http://localhost:8545'))
...
abi=[IWETH_ABI])
uniswap_factory = web3.eth.contract(address=uniswap_factory_address, abi=[IUNISWAP_FACTORY_ABweb3.eth.contract(address=uniswap_factory_address,abi=[IUNISWAP_FACTORY_ABI])
